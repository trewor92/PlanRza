...
namespace PlanRza.Migrations
{
    ...
    [Migration("20200606160018_Initial1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlanRza.Models.Branch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PlanRza.Models.Equipment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PlanRza.Models.Substation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PlanRza.Models.Breaker", b =>
                {
                    b.HasBaseType("PlanRza.Models.Equipment");
            ...
            modelBuilder.Entity("PlanRza.Models.CurrentTransformer", b =>
                {
                    b.HasBaseType("PlanRza.Models.Equipment");
            ...
            modelBuilder.Entity("PlanRza.Models.Transformer", b =>
                {
                    b.HasBaseType("PlanRza.Models.Equipment");
            ...
            modelBuilder.Entity("PlanRza.Models.VoltageTransformer", b =>
                {
                    b.HasBaseType("PlanRza.Models.Equipment");
            ...
            modelBuilder.Entity("PlanRza.Models.Equipment", b =>
                {
                    b.HasOne("PlanRza.Models.Substation", null)
                        .WithMany("Equipments")
            ...
            modelBuilder.Entity("PlanRza.Models.Substation", b =>
                {
                    b.HasOne("PlanRza.Models.Branch", null)
